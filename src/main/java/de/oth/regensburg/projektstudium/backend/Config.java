...
public class Config extends WebMvcConfigurerAdapter {
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            log.info("Preloading " + buildingRepository.save(u22));
            ...
            employeeRepository.save(tomCruise);
